...
class ScoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scout" do
    assert_difference('Scout.count') do
      post scouts_url, params: { scout: { birthdate: @scout.birthdate, grade: @scout.grade, name: @scout.name, patrol_id: @scout.patrol_id } }
    end
  ...
  test "should update scout" do
    patch scout_url(@scout), params: { scout: { birthdate: @scout.birthdate, grade: @scout.grade, name: @scout.name, patrol_id: @scout.patrol_id } }
