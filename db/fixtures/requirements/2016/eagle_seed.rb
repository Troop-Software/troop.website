...
Requirement.seed(sortOrder: 5,req_num: '5', revision: '2016', rank_id:8, req_category: :general,  description: 'While a Life Scout, plan, develop, and give leadership to others in a service project helpful to any religious institution, any school, or your community. (The project must benefit an organization other than the Boy Scouts of America.) A project proposal must be approved by the organization benefiting from the effort, your Scoutmaster and unit committee, and the council or district before you start. You must use the Eagle Scout Service Project Workbook, BSA publication No. 512-927, in meeting this requirement. (To learn more about the Eagle Scout service project, see the Guide to Advancement, topics 9.0.2.0 through 9.0.2.15.)')
Requirement.seed(sortOrder: 6,req_num: '6', revision: '2016', rank_id:8, req_category: :general,  description: 'While a Life Scout, participate in a Scoutmaster conference.')
...
Requirement.seed(sortOrder: 8,req_num: '7', revision: '2016', rank_id:8, req_category: :general, bor: true, description: 'Successfully complete your board of review for the Eagle Scout rank.10 (This requirement may be met after age 18 in accordance with Guide to Advancement, topic 8.0.3.1.)')
